...
use serde_json::json;
use wickra_strategy_ci_core::flatten_report;
...
fn property_tags_are_pinned() {
    use wickra_strategy_ci_core::Property;
...
fn perturbation_tags_are_pinned() {
    use wickra_strategy_ci_core::Perturbation;
    roundtrip(
...
fn tolerance_and_diffkind_tags_are_pinned() {
    use wickra_strategy_ci_core::{DiffKind, Tolerance};
    roundtrip(
