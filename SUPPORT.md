...
Thanks for using `wickra-strategy-ci`. Here is where to go for help.
...
- Open a [GitHub Discussion](https://github.com/wickra-lib/wickra-strategy-ci/discussions)
...
`wickra-strategy-ci` is a research and engineering tool: it evaluates conditions
